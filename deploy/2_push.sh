...
# Syncs code + data to the OCI server.
#
# Usage:
#   bash deploy/2_push.sh <server-ip> [path/to/ssh-key]
#
# Examples:
#   bash deploy/2_push.sh 152.67.100.50
