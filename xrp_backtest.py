...
scenarios = [
    ("XRP MEGA-BULL Q1-2021", "2021-01-01", "2021-03-31"),
    ("XRP ATH-CRASH Q4-2021", "2021-10-01", "2021-12-31"),
    ("XRP BEAR      Q2-2022", "2022-04-01", "2022-06-30"),
    ("XRP RECOVERY  Q1-2023", "2023-01-01", "2023-03-31"),
    ("XRP BREAKOUT  Q1-2024", "2024-01-01", "2024-03-31"),
    ("XRP PULLBACK  Q3-2024", "2024-07-01", "2024-09-30"),
]

print(f"\nXRPUSDT CROSS-ASSET VALIDATION  ({len(scenarios)} scenarios)\n")
results = []
