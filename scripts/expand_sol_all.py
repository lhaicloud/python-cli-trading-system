"""Expand SOL training data — sequential, no stdout wrapper."""
import datetime
...
RUNS = [
    ...
    ("SOL Jan-Apr 2023", "2023-01-01", "2023-04-30"),
    ("SOL Nov-Dec 2023", "2023-11-01", "2023-12-31"),
    ("SOL Jan-Mar 2024", "2024-01-01", "2024-03-31"),
    ("SOL Apr-Jun 2024", "2024-04-01", "2024-06-30"),
    ("SOL Jul-Sep 2024", "2024-07-01", "2024-09-30"),
    ("SOL Oct-Dec 2024", "2024-10-01", "2024-12-31"),
    ("SOL Jan-Mar 2025", "2025-01-01", "2025-03-31"),
    ("SOL Apr-Jun 2025", "2025-04-01", "2025-06-30"),
]
