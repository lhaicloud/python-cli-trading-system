"""ETH expansion: 2022 missing months + 2023 Q4 (both very thin)"""
import datetime
...
CAPITAL = 10_000.0
RUNS = [
    ("ETH Jul-Sep 2022", "2022-07-01", "2022-09-30"),
    ("ETH Oct-Dec 2022", "2022-10-01", "2022-12-31"),
    ("ETH Apr-Jun 2023", "2023-04-01", "2023-06-30"),
    ("ETH Oct-Dec 2023", "2023-10-01", "2023-12-31"),
]
total = 0
