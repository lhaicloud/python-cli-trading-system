"""ADAUSDT Cross-Asset Validation — 6 scenarios across different market regimes."""
...
SCENARIOS = [
    ("ADA MEGA-BULL  Q1-2021",  "2021-01-01", "2021-03-31"),  # ADA $0.17->$1.20
    ("ADA ATH-CRASH  Q4-2021",  "2021-10-01", "2021-12-31"),  # ADA $2.10->$2.97->$1.30
    ("ADA BEAR       Q2-2022",  "2022-04-01", "2022-06-30"),  # ADA $1.20->$0.45
    ("ADA RECOVERY   Q1-2023",  "2023-01-01", "2023-03-31"),  # ADA $0.25->$0.40
    ("ADA BREAKOUT   Q1-2024",  "2024-01-01", "2024-03-31"),  # ADA $0.55->$0.75
    ("ADA PULLBACK   Q3-2024",  "2024-07-01", "2024-09-30"),  # ADA $0.40->$0.35
]
...
print(f"\n{'='*60}")
print(f"  ADAUSDT CROSS-ASSET VALIDATION  (6 scenarios)")
print(f"{'='*60}")
