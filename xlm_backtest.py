"""XLMUSDT Cross-Asset Validation — 6 scenarios."""
...
SCENARIOS = [
    ("XLM MEGA-BULL  Q1-2021", "2021-01-01", "2021-03-31"),  # XLM $0.13->$0.75
    ("XLM ATH-CRASH  Q4-2021", "2021-10-01", "2021-12-31"),  # XLM $0.37->$0.50->$0.27
    ("XLM BEAR       Q2-2022", "2022-04-01", "2022-06-30"),  # XLM $0.22->$0.09
    ("XLM RECOVERY   Q1-2023", "2023-01-01", "2023-03-31"),  # XLM $0.08->$0.10
    ("XLM BREAKOUT   Q1-2024", "2024-01-01", "2024-03-31"),  # XLM $0.12->$0.18
    ("XLM PULLBACK   Q3-2024", "2024-07-01", "2024-09-30"),  # XLM $0.10->$0.09
]
CAPITAL  = 10_000.0
RISK_PCT = 1.0
SYMBOL   = "XLMUSDT"
...
print(f"\n{'='*60}")
print(f"  XLMUSDT CROSS-ASSET VALIDATION  (6 scenarios)")
print(f"{'='*60}")
